 ...
 * 
 * @section usage Usage
 * You should be able to run ARSnovawidget from desktop. It starts with a simple
 ...
 * 
 * To get information about how to build ARSnovawidget, take a look at the
 * @link build build instructions @endlink.
 * 
 * ARSnovawidget uses unit testing. Make shoure you have read the
 ...
 * ARSnovawidget uses unit tests to ensure a higher quality of the resulting software.
